...
<head>
    ...
    <style>
        ...
        * {
        ...
        .hero {
            background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('https://scontent.fcai20-1.fna.fbcdn.net/v/t39.30808-6/475443882_632748869170388_6908265376486829765_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=833d8c&_nc_ohc=swj-tu-BTMMQ7kNvwF0AOSE&_nc_oc=AdkAi9-n45uiM9VCRaS0me62alJX6hohZqjte8SqLiKkqiTV65aQ9eIkflS1Mo9tc54&_nc_zt=23&_nc_ht=scontent.fcai20-1.fna&_nc_gid=Xgkk-bAqVBFsWfXD5ms0WA&oh=00_AfmJ5NI2HEPuwdClezgW3xaUq-ypqczQYzKc3HUsIJms8w&oe=694E3842');
...
>>>>>>> f83a312 (Add categories, views, controllers, CSS, and images)
            </div>
        </div>
    </section>
...
=======
    ...
    <main class="container">
        ...
        <section class="hero">
            <div class="hero-content">
                <h2>Craving something delicious?</h2>
                <p>order now and get as soon as possible!</p>
                <a href="http://localhost/talabat/public/index.php?page=vendor&vendor=mycorner" class="hero-btn-link">
                    <button class="hero-btn">Order Now</button>
                </a>
            </div>
        </section>
    ...
    <div class="categories-grid">
        <a href="index.php?page=category&cat=fastfood" class="category-card">
            <div class="category-icon">
                <i class="fas fa-pizza-slice"></i>
            </div>
            <div class="category-name">Fast Food</div>
        ...
        <a href="index.php?page=category&cat=desserts" class="category-card">
            <div class="category-icon">
                <i class="fas fa-ice-cream"></i>
            </div>
            <div class="category-name">Desserts</div>
        ...
        <a href="index.php?page=category&cat=chicken" class="category-card">
            <div class="category-icon">
                <i class="fas fa-drumstick-bite"></i>
            </div>
            <div class="category-name">Chicken</div>
        ...
        <a href="index.php?page=category&cat=healthy" class="category-card">
            <div class="category-icon">
                <i class="fas fa-leaf"></i>
            </div>
            <div class="category-name">Healthy</div>
        ...
        <a href="index.php?page=category&cat=cafes" class="category-card">
            <div class="category-icon">
                <i class="fas fa-coffee"></i>
            </div>
            <div class="category-name">Cafés</div>
        ...
        <a href="index.php?page=category&cat=bakeries" class="category-card">
            <div class="category-icon">
                <i class="fas fa-bread-slice"></i>
            </div>
            <div class="category-name">Bakeries</div>
                ...
                <div class="deals-grid">
                    <div class="deal-card">
                        ...
                        <div class="deal-content">
                            <h3 class="deal-title">Cinnabon Special</h3>
                            <p class="deal-description">Exclusive Cinnabon desserts and treats with amazing discounts</p>
                            <a href="http://localhost/talabat/public/index.php?page=vendor&vendor=mycorner">
                                <button class="deal-button">Grab Deal</button>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="deal-card">
                        ...
                        <div class="deal-content">
                            <h3 class="deal-title">My Corner</h3>
                            <p class="deal-description">Egyptian traditional food with special prices</p>
                            <a href="http://localhost/talabat/public/index.php?page=vendor&vendor=mycorner">
                                <button class="deal-button">Grab Deal</button>
                            </a>
                        </div>
